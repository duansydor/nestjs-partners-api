...
import { ReservarEventoRequest } from './request/reservar-lugar.request';
...
export class EventosController {
  ...
  reserveSpot(
    ...
    return this.eventsService.reserveSpot({
      eventId,
      spots: reservarEventoRequest.lugares,
      ticket_kind:
        reservarEventoRequest.tipo_ingresso === 'inteira'
          ? TicketKind.full
          : TicketKind.half,
      email: reservarEventoRequest.email,
    });
  }
}
